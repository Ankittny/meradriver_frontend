                ...
                <div className="row">
                    ...
                    <div className="col-lg-4">
                        <div className="footer-heading">
                            ...
                            <ul className="glad-item">
                                ...
                                <li>Booking your personal driver through Meradriver app
                                    launching soon</li>
                    ...
                    <div className="col-lg-4">
                        <div className="footer-heading">
                            ...
                            <p>We are a driver management company based in Delhi. It is
                                the first professional driver management company in India.
                                It is a platform where you can find a driver according to
                                your requirements.</p>
                        </div>
